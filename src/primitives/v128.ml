...
let i64_of_i16x4 a b c d =
  i64_of_i32x2 (i32_of_i16x2 a b) (i32_of_i16x2 c d)

let i32_of_i8x4 a b c d =
  i32_of_i16x2 (i16_of_i8x2 a b) (i16_of_i8x2 c d)
...
let of_i8x16 a b c d e f g h i j k l m n o p =
  I64x2 (i64_of_i8x8 a b c d e f g h,
         i64_of_i8x8 i j k l m n o p)

let of_i16x8 a b c d e f g h =
  I64x2 (i64_of_i16x4 a b c d,
         i64_of_i16x4 e f g h)
...
let to_i64x2 t =
  ...
  | I32x4 (a, b, c, d) ->
    ...
    i64_of_i32x2 c d
  | F64x2 (a, b) ->
    Float64.to_bits a, Float64.to_bits b
  | F32x4 (a, b, c, d) ->
...
let pp ppf v =
  ...
  | F32x4 (a, b, c, d) ->
    Fmt.pf ppf "f32x4 %a %a %a %a"
      Float32.pp a Float32.pp b Float32.pp c Float32.pp d
