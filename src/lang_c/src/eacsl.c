...
// Copyright (C) 2012-2024 CEA (Commissariat à l'énergie atomique et aux
// énergies alternatives This file is originally from the Frama-C's E-ACSL
// plug-in available at
// https://git.frama-c.com/pub/frama-c/-/tree/master/src/plugins/e-acsl
...
static inline int normalize_to_boolean(int value) { return value ? 1 : 0; }

__e_acsl_contract_t *__e_acsl_contract_init(size_t size) {
  // Allocate memory for the structure
  __e_acsl_contract_t *c = malloc(sizeof(__e_acsl_contract_t));
  // DVASSERT(c != NULL, "Unable to allocate %d bytes of memory for
  // contract_t\n",
...
/* Contract behaviors */
void __e_acsl_contract_set_behavior_assumes(__e_acsl_contract_t *c, size_t i,
                                            int assumes) {
...
int __e_acsl_contract_get_behavior_assumes(const __e_acsl_contract_t *c,
                                           size_t i) {
  size_t char_idx = find_char_index(i);
  // DVASSERT(char_idx < c->char_count,
  //          "Out of bound char index %d (char_count: %d)\n", char_idx,
...
int __e_acsl_contract_partial_count_behaviors(const __e_acsl_contract_t *c,
                                              size_t count, ...) {
  va_list args;
  va_start(args, count);
...
int __e_acsl_contract_partial_count_all_behaviors(
    const __e_acsl_contract_t *c) {
  int result = 0;
...
void __e_acsl_assert_register_bool(__e_acsl_assert_data_t *data,
                                   const char *name, int is_enum, _Bool value) {
}
void __e_acsl_assert_register_char(__e_acsl_assert_data_t *data,
                                   const char *name, int is_enum, char value) {}
void __e_acsl_assert_register_schar(__e_acsl_assert_data_t *data,
                                    const char *name, int is_enum,
                                    signed char value) {}
void __e_acsl_assert_register_uchar(__e_acsl_assert_data_t *data,
                                    const char *name, int is_enum,
                                    unsigned char value) {}
void __e_acsl_assert_register_int(__e_acsl_assert_data_t *data,
                                  const char *name, int is_enum, int value) {}
void __e_acsl_assert_register_uint(__e_acsl_assert_data_t *data,
                                   const char *name, int is_enum,
                                   unsigned int value) {}
void __e_acsl_assert_register_short(__e_acsl_assert_data_t *data,
                                    const char *name, int is_enum,
                                    short value) {}
void __e_acsl_assert_register_ushort(__e_acsl_assert_data_t *data,
                                     const char *name, int is_enum,
                                     unsigned short value) {}
void __e_acsl_assert_register_long(__e_acsl_assert_data_t *data,
                                   const char *name, int is_enum, long value) {}
void __e_acsl_assert_register_ulong(__e_acsl_assert_data_t *data,
                                    const char *name, int is_enum,
                                    unsigned long value) {}
void __e_acsl_assert_register_longlong(__e_acsl_assert_data_t *data,
                                       const char *name, int is_enum,
                                       long long value) {}
void __e_acsl_assert_register_ulonglong(__e_acsl_assert_data_t *data,
                                        const char *name, int is_enum,
                                        unsigned long long value) {}
void __e_acsl_assert_register_generic_real(
    __e_acsl_assert_data_t *data, const char *name,
    __e_acsl_assert_data_rkind_t kind,
    __e_acsl_assert_data_real_value_t value) {}
void __e_acsl_assert_register_float(__e_acsl_assert_data_t *data,
                                    const char *name, float value) {}
void __e_acsl_assert_register_double(__e_acsl_assert_data_t *data,
                                     const char *name, double value) {}
void __e_acsl_assert_register_longdouble(__e_acsl_assert_data_t *data,
                                         const char *name, long double value) {}
void __e_acsl_assert_register_ptr(__e_acsl_assert_data_t *data,
                                  const char *name, void *ptr) {}
void __e_acsl_assert_register_array(__e_acsl_assert_data_t *data,
                                    const char *name, void *array) {}
void __e_acsl_assert_register_fun(__e_acsl_assert_data_t *data,
                                  const char *name) {}
void __e_acsl_assert_register_struct(__e_acsl_assert_data_t *data,
                                     const char *name) {}
void __e_acsl_assert_register_union(__e_acsl_assert_data_t *data,
                                    const char *name) {}
void __e_acsl_assert_register_other(__e_acsl_assert_data_t *data,
                                    const char *name) {}
