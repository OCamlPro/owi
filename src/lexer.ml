...
let keywords =
  ...
  Array.iter
    ...
    [| ("align", ALIGN)
     ...
     ; ("array.len", ARRAY_LEN)
     ; ("array.new_canon", ARRAY_NEW_CANON)
     ; ("array.new_canon_data", ARRAY_NEW_CANON_DATA)
     ; ("array.new_canon_default", ARRAY_NEW_CANON_DEFAULT)
     ; ("array.new_canon_elem", ARRAY_NEW_CANON_ELEM)
     ; ("array.new_canon_fixed", ARRAY_NEW_CANON_FIXED)
     ; ("array.set", ARRAY_SET)
     ...
     ; ("struct.new_canon", STRUCT_NEW_CANON)
     ; ("struct.new_canon_default", STRUCT_NEW_CANON_DEFAULT)
