...
module Module : sig
  ...
  val add_func : (func, block_type) Runtime.t -> t -> t * indice

  val add_import_if_not_present :
    modul_name:string -> func_name:string -> desc:block_type -> t -> t
  ...
  val find_exported_func_from_name : string -> t -> export option
end
