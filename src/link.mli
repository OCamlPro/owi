...
val set_global : Simplify.module_ array -> int -> int -> Types.const -> unit

val get_global :
  Simplify.module_ array -> int -> int -> int * Types.global_type * Types.const

val get_func : Simplify.module_ array -> int -> int -> int * Types.simplified_indice Types.func
