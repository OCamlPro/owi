**.eq eqz lt gt ...  instructions:
  $ dune exec -- owi --debug --optimize relop_testop.wast
  parsing      ...
  checking     ...
  grouping     ...
  assigning    ...
