binary operations instructions:
  $ dune exec -- owi run --debug --optimize binop.wast
  parsing      ...
  checking     ...
  grouping     ...
  assigning    ...
