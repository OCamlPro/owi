...
;; TODO (assert_return (invoke "set-externref" (i32.const 0) (ref.extern 1)))
;; TODO (assert_return (invoke "get-externref" (i32.const 0)) (ref.extern 1))
...
;; TODO (assert_trap (invoke "set-externref" (i32.const 2) (ref.extern 0)) "out of bounds table access")
(assert_trap (invoke "set-funcref-from" (i32.const 3) (i32.const 1)) "out of bounds table access")
;; TODO (assert_trap (invoke "set-externref" (i32.const -1) (ref.extern 0)) "out of bounds table access")
