...
;; TODO: (assert_trap (invoke "set" (i32.const 0) (ref.extern 2)) "out of bounds table access")
...
;; TODO: (assert_return (invoke "set" (i32.const 0) (ref.extern 2)))
;; TODO: (assert_return (invoke "get" (i32.const 0)) (ref.extern 2))
;; TODO: (assert_trap (invoke "set" (i32.const 1) (ref.extern 2)) "out of bounds table access")
(assert_trap (invoke "get" (i32.const 1)) "out of bounds table access")

;; TODO: (assert_return (invoke "grow" (i32.const 4) (ref.extern 3)) (i32.const 1))
