...
(assert_return (invoke "f64.promote_f32" (f32.const -inf)) (f64.const -inf))
;; TODO: parse this (assert_return (invoke "f64.promote_f32" (f32.const nan)) (f64.const nan:canonical))
;; TODO: parse this (assert_return (invoke "f64.promote_f32" (f32.const nan:0x200000)) (f64.const nan:arithmetic))
;; TODO: parse this (assert_return (invoke "f64.promote_f32" (f32.const -nan)) (f64.const nan:canonical))
;; TODO: parse this (assert_return (invoke "f64.promote_f32" (f32.const -nan:0x200000)) (f64.const nan:arithmetic))
...
;; TODO: (assert_return (invoke "f32.demote_f64" (f64.const nan)) (f32.const nan:canonical))
;; TODO: (assert_return (invoke "f32.demote_f64" (f64.const nan:0x4000000000000)) (f32.const nan:arithmetic))
;; TODO: (assert_return (invoke "f32.demote_f64" (f64.const -nan)) (f32.const nan:canonical))
;; TODO: (assert_return (invoke "f32.demote_f64" (f64.const -nan:0x4000000000000)) (f32.const nan:arithmetic))
