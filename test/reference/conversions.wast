...
(assert_return (invoke "f64.promote_f32" (f32.const -inf)) (f64.const -inf))
;; TODO (assert_return (invoke "f64.promote_f32" (f32.const nan)) (f64.const nan:canonical))
;; TODO (assert_return (invoke "f64.promote_f32" (f32.const nan:0x200000)) (f64.const nan:arithmetic))
;; TODO (assert_return (invoke "f64.promote_f32" (f32.const -nan)) (f64.const nan:canonical))
;; TODO (assert_return (invoke "f64.promote_f32" (f32.const -nan:0x200000)) (f64.const nan:arithmetic))
