...
static RBNode *get_tree_node_by_key(TreeTable const *const table,
                                    const void *key);
 ...
 */
enum cc_stat treetable_new(int (*cmp)(const void *, const void *),
                           TreeTable **tt) {
  TreeTableConf conf;
...
/**
 * Creates a new TreeTable based on the specified TreeTableConf struct and
 * returns a status code.
 *
 * The table is allocated using the memory allocators specified in the
 * TreeTableConf struct.
 *
 ...
 */
enum cc_stat treetable_new_conf(TreeTableConf const *const conf,
                                TreeTable **tt) {
 ...
 */
enum cc_stat treetable_get(TreeTable const *const table, const void *key,
                           void **out) {
 ...
 */
enum cc_stat treetable_get_first_value(TreeTable const *const table,
                                       void **out) {
 ...
 * @return CC_OK if the key was found, or CC_ERR_VALUE_NOT_FOUND if not.
 */
enum cc_stat treetable_get_last_value(TreeTable const *const table,
                                      void **out) {
 ...
 * @return CC_OK if the key was found, or CC_ERR_KEY_NOT_FOUND if not.
 */
enum cc_stat treetable_get_greater_than(TreeTable const *const table,
 ...
 */
size_t treetable_size(TreeTable const *const table) { return table->size; }
 ...
 */
size_t treetable_contains_value(TreeTable const *const table,
                                const void *value) {
  RBNode *node = tree_min(table, table->root);
