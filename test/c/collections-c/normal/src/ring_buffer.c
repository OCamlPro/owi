...
bool rbuf_is_empty(Rbuf *rbuf) { return (rbuf->size == 0); }

size_t rbuf_size(Rbuf *rbuf) { return rbuf->size; }
...
uint64_t rbuf_peek(Rbuf *rbuf, int index) { return rbuf->buf[index]; }
