  ...
  owi: internal error, uncaught exception:
       ...
       Called from Owi__Interpret.Make.exec_instr in file "src/interpret/interpret.ml", line 1576, characters 24-58
       Called from Owi__Interpret.Make.loop in file "src/interpret/interpret.ml", line 1590, characters 19-53
  ...
  owi: internal error, uncaught exception:
       File "src/interpret/interpret.ml", line 849, characters 4-10: Assertion failed
       Raised at Owi__Interpret.Make.call_ref in file "src/interpret/interpret.ml" (inlined), line 849, characters 4-16
       Called from Owi__Interpret.Make.exec_instr in file "src/interpret/interpret.ml", line 1577, characters 31-64
       Called from Owi__Interpret.Make.loop in file "src/interpret/interpret.ml", line 1590, characters 19-53
       Called from Owi__Interpret.Make.exec_vfunc_from_outside in file "src/interpret/interpret.ml", lines 1679-1696, characters 6-9
       Called from Owi__Script.run.(fun) in file "src/script/script.ml", line 304, characters 21-40
       Called from Owi__Syntax.list_fold_left.aux in file "src/infra/syntax.ml", line 42, characters 12-19
