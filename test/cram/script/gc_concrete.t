  ...
  Failure("Assigned: unimplemented for rec and sub types")
  $ owi script concrete --no-exhaustion reference/return_call_ref.wast 2>&1 | grep -oE ".*Assertion failed"
  [1]
  $ owi script concrete --no-exhaustion reference/struct.wast 2>&1 | grep -oE "Failure.*"
  Failure("Assigned: unimplemented for rec and sub types")
  $ owi script concrete --no-exhaustion reference/type-subtyping.wast 2>&1 | grep -oE "Failure.*"
  Failure("Assigned: unimplemented for rec and sub types")
