add binop:
  $ owi wasm sym add_i32.wat --no-value --deterministic-result-order
  ...
  $ owi wasm sym add_i64.wat --no-value --deterministic-result-order
  ...
  $ owi wasm sym add_f32.wat --no-value --deterministic-result-order
  ...
  $ owi wasm sym add_f64.wat --no-value --deterministic-result-order
