mul binop:
  $ owi wasm sym mul_i32.wat --no-value --deterministic-result-order
  ...
  $ owi wasm sym mul_i64.wat --no-value --deterministic-result-order
  ...
  $ owi wasm sym mul_f32.wat --no-value --deterministic-result-order
  ...
  $ owi wasm sym mul_f64.wat --no-value --deterministic-result-order
