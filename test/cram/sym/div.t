div binop:
  $ owi wasm sym div_i32.wat --no-value --deterministic-result-order -w1
  ...
  $ owi wasm sym div_i64.wat --no-value --deterministic-result-order -w1
  owi: [ERROR] Trap: integer overflow
  model {
    symbol symbol_0 i64
    symbol symbol_1 i64
  ...
  $ owi wasm sym div_f32.wat --no-value --deterministic-result-order -w1
  ...
  $ owi wasm sym div_f64.wat --no-value --deterministic-result-order -w1
  ...
  $ owi wasm sym div_zero.wat --deterministic-result-order -w1
  owi: [ERROR] Trap: integer divide by zero
  model {
