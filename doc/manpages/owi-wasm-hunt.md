[owi](owi.md) › [owi wasm](owi-wasm.md) › **owi wasm hunt**
...
```text
NAME
       owi-wasm-hunt - Hunt bugs by combining the fuzzer and the symbolic
       execution engine.

SYNOPSIS
       owi wasm hunt [OPTION]… FILE
...
ENVIRONMENT
       These environment variables affect the execution of owi wasm hunt:
