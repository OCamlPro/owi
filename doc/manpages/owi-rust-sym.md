[owi](owi.md) › [owi rust](owi-rust.md) › **owi rust sym**
...
```text
NAME
       owi-rust-sym - Run the symbolic execution engine on a Rust program.

SYNOPSIS
       owi rust sym [OPTION]… FILE…
...
ENVIRONMENT
       These environment variables affect the execution of owi rust sym:
