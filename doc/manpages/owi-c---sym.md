[owi](owi.md) › [owi c++](owi-c--.md) › **owi c++ sym**
...
```text
NAME
       owi-c++-sym - Run the symbolic execution engine on a C++ program.

SYNOPSIS
       owi c++ sym [OPTION]… FILE…
...
ENVIRONMENT
       These environment variables affect the execution of owi c++ sym:
