[owi](owi.md) › [owi llvm](owi-llvm.md) › **owi llvm sym**
...
```text
NAME
       owi-llvm-sym - Run the symbolic execution engine on a LLVM program.

SYNOPSIS
       owi llvm sym [OPTION]… FILE…
...
ENVIRONMENT
       These environment variables affect the execution of owi llvm sym:
