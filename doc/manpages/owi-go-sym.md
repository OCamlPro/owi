[owi](owi.md) › [owi go](owi-go.md) › **owi go sym**
...
```text
NAME
       owi-go-sym - Run the symbolic execution engine on a Go program.

SYNOPSIS
       owi go sym [OPTION]… FILE…
...
ENVIRONMENT
       These environment variables affect the execution of owi go sym:
