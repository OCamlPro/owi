[owi](owi.md) › [owi wasm](owi-wasm.md) › **owi wasm iso**
...
```text
NAME
       owi-wasm-iso - Check the iso-functionnality of two modules by
       comparing the output when calling their exports.

SYNOPSIS
       owi wasm iso [OPTION]… FILE…
...
ENVIRONMENT
       These environment variables affect the execution of owi wasm iso:
