[owi](owi.md) › [owi haskell](owi-haskell.md) › **owi haskell sym**
...
```text
NAME
       owi-haskell-sym - Run the symbolic execution engine on a Haskell
       program.

SYNOPSIS
       owi haskell sym [OPTION]… FILE…
...
ENVIRONMENT
       These environment variables affect the execution of owi haskell sym:
