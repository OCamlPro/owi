[owi](owi.md) › [owi wasm](owi-wasm.md) › **owi wasm fuzz**
...
```text
NAME
       owi-wasm-fuzz - Run the fuzzer.

SYNOPSIS
       owi wasm fuzz [OPTION]… FILE
...
ENVIRONMENT
       These environment variables affect the execution of owi wasm fuzz:
