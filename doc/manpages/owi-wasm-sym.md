[owi](owi.md) › [owi wasm](owi-wasm.md) › **owi wasm sym**
...
```text
NAME
       owi-wasm-sym - Run the symbolic execution engine.

SYNOPSIS
       owi wasm sym [OPTION]… FILE
...
ENVIRONMENT
       These environment variables affect the execution of owi wasm sym:
